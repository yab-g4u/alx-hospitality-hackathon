...
interface ProfessionalPassportProps {
  onClose?: () => void
  onGenerateQR?: (visitId: string) => void
  isFirstTime?: boolean
}

export function ProfessionalPassport({ onClose, onGenerateQR, isFirstTime = false }: ProfessionalPassportProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-4 border-2 border-kuriftu-gold/30 rounded-lg pointer-events-none" />
          ...
          <div className="relative bg-kuriftu-gold text-kuriftu-brown p-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs opacity-80 font-amharic">የኩሪፍቱ ጉዞ ፓስፖርት</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="relative">
                ...
                {/* Gold seal for premium members */}
                <div className="absolute -bottom-1 -right-1 h-6 w-6 rounded-full bg-kuriftu-gold flex items-center justify-center">
                  <Award className="h-3 w-3 text-kuriftu-brown" />
                </div>
              </div>
              <div>
              ...
              {showTools && (
                ...
                >
                  <div className="grid grid-cols-3 gap-2">
                    <Button variant="ghost" size="sm" className="flex flex-col items-center h-auto py-2 text-white">
            ...
            {isFirstTime ? (
              <div className="relative min-h-[300px] bg-white rounded-lg p-4 border border-kuriftu-gold/30 shadow-md flex flex-col items-center justify-center">
                ...
                <h3 className="font-serif text-lg font-semibold text-kuriftu-brown mb-2 text-center">
                  Begin Your Ethiopian Journey
                </h3>
                <p className="text-sm text-muted-foreground text-center mb-2">
                  Your passport is ready to collect stamps from Kuriftu's luxury experiences
                </p>
                <p className="font-amharic text-sm text-kuriftu-brown mb-4 text-center">የኢትዮጵያ ጉዞዎን ይጀምሩ</p>
                <Button
                  variant="outline"
                  className="border-kuriftu-brown text-kuriftu-brown hover:bg-kuriftu-brown hover:text-white"
                  onClick={() => onGenerateQR && onGenerateQR("bishoftu")}
                >
              ...
              /* Resort page for returning users */
              <div className="relative min-h-[300px] bg-white rounded-lg p-4 border border-kuriftu-gold/30 shadow-md">
                ...
                {/* Gold embossed corner */}
                <div className="absolute top-0 right-0 w-16 h-16 overflow-hidden">
                  <div className="absolute top-0 right-0 w-16 h-16 bg-kuriftu-gold/20 transform rotate-45 translate-x-8 translate-y--8"></div>
                </div>
                          ...
                          <div key={visit.id} className="relative" onClick={() => handleStampClick(visit.id)}>
                            ...
                            >
                              ...
                              <div className="relative z-10 flex flex-col items-center">
                                ...
                                {/* Amharic name */}
                                <p className="text-xs font-amharic text-center mt-1 text-kuriftu-brown">
                                  {getAmharicName(visit.experienceId)}
                                </p>

                                {/* Local hero reference */}
                                <div className="absolute bottom-1 left-1 right-1">
                                  <p className="text-[8px] italic text-muted-foreground line-clamp-1 text-center">
                                  ...
                                  <div className="relative">
                                    ...
                                    <div className="relative h-24 w-24 rounded-full border-4 border-kuriftu-gold flex items-center justify-center bg-white/80 backdrop-blur-sm">
                                      <div className="text-center">
                                        ...
                                        <p className="text-[8px] font-amharic text-kuriftu-brown/70">ኩሪፍቱ</p>
                                      </div>
                                    </div>
                                  </div>
                                </motion.div>
